<?php
require_once $this->default_theme_path.'/flatgrid/config.php';

	$this->set_css($this->default_theme_path.'/flatgrid/css/flexigrid.css');
	...
	$this->set_js($this->default_theme_path.'/flatgrid/js/cookies.js');
	$this->set_js($this->default_theme_path.'/flatgrid/js/flexigrid.js');

    $this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.form.min.js');

	$this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.numeric.min.js');
	$this->set_js($this->default_theme_path.'/flatgrid/js/jquery.printElement.min.js');
...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="tDiv">
		...
		<div class="tDiv2">
			...
			<div class="fbutton1 btn btn-default btn-success">
				<div>
					<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>	<span class="add1"><?php echo $this->l('list_add'); ?> <?php echo $subject?></span>
				</div>
			</div>
            </a>
			<div class="btnseparator1">
			</div>
		</div>
		<?php }?>
		<div class="tDiv3">
        	...
        	<a class="export-anchor" data-url="<?php echo $export_url; ?>" target="_blank">
				<div class="fbutton1  btn btn-default">
					<div>
						<span class="glyphicon glyphicon-floppy-save" aria-hidden="true"></span> <span class="export"><?php echo $this->l('list_export');?></span>
					</div>
				</div>
            </a>
        	...
        	<a class="print-anchor" data-url="<?php echo $print_url; ?>">
				<div class="fbutton1  btn btn-default">
					<div>
						<span class="glyphicon glyphicon-print" aria-hidden="true"></span>	<span class="print"><?php echo $this->l('list_print');?></span>
					</div>
				</div>
            </a>
			<div class="btnseparator1"></div>
			<?php }?>
		</div>
		<div class='clear'></div>
	</div>
	...
	<div class="sDiv quickSearchBox" id='quickSearchBox'>
		<div class="sDiv2">
			...
			<button type="button" class="crud_search btn btn-default" aria-label="Left Align" id='crud_search'>
				<span class="glyphicon glyphicon-search" aria-hidden="true"></span> <?php echo $this->l('list_search');?>
			</button>

			 <!-- <input type="button" value="" class="crud_search btn btn-default" > -->
		</div>
        <div class='search-div-clear-button'>
        	<button type="button" value="" id='search_clear' class="search_clear btn btn-default">
				<span class="glyphicon glyphicon-erase" aria-hidden="true"></span> <?php echo $this->l('list_clear_filtering');?>
			</button>
        </div>
	</div>
	<div class="pDiv">
		<div class="pDiv2">
			...
			<div class="pGroup">
				<div class="pNext pButton btn btn-default next-button" ><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span></div>
				<div class="pLast pButton last-button btn btn-default"><span class="glyphicon glyphicon-step-forward" aria-hidden="true"></span></div>
			</div>
			<div class="btnseparator">
			</div>
			<div class="pGroup">
