                ...
                <form action="<?php echo base_url() . "registro_c/registrar_user" ?>" class="d-flex flex-wrap" method="POST">
                    <div class="col-lg-6 col-sm-12">
                        ...
                        <div class="form-group text-center mx-auto input-group mb-4 mt-0">
                            ...
                            <input type="password" required name="password" class="form-control" placeholder="Contraseña" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                        <div class="form-group text-center mx-auto input-group mb-4">
                            ...
                            <input type="date" required name="fecha_nac" class="form-control" placeholder="Fecha de Nacimiento" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                        <div class="form-group text-center mx-auto input-group mb-4 d-none" id="group-liga">
                            ...
                            <input type="text" id="nombreliga" minlength="6" name="nombre_liga" class="form-control" placeholder="Nombre de liga" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="form-group text-center mx-auto input-group mb-0 m-b-error">
                            ...
                            <input type="email" required id="email" name="email" class="form-control" id="inputDNI" placeholder="Email">
                        ...
                        <div class="form-group text-center mx-auto input-group mb-4 mt-0">
                            ...
                            <input type="text" required name="apenom" class="form-control" placeholder="Apellidos y Nombre" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                        <div class="form-group text-center mx-auto input-group mb-4">
                        ...
                        <div class="form-group text-center mx-auto input-group mb-4 d-none" id="group-ligaclave">
                            ...
                            <input type="password" id="clave_liga" name="clave_liga" class="form-control" placeholder="Clave de liga" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                    </div>
